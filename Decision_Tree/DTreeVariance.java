...
class DTreeVariance{
	...
	DTreeVariance(DTreeVariance orig){
	...
	DTreeVariance(instance trainSet){
	...
	void createTree(instance trainSet, Node node){
	...
	int bestAttrib(instance instance, Node node){
	...
	double buildAndCalcGain(instance instance, String attrVal,Node node){
...
public static void main(String[] args) throws IOException{
	...
	instance trainSet = new instance(trainingSet);
	DTreeVariance tree = new DTreeVariance(trainSet);
	instance vSet = new instance(validationSet);
	instance testSet = new instance(testingSet);
	...
	DTreeVariance copyTree = new DTreeVariance(tree);
	DTreeVariance prunedTree = tree.prune(L,K,vSet);
	...
	double calculateAccuracy(instance instances){
...
DTreeVariance prune(int L, int K, instance instances){

	DTreeVariance bestTree = new DTreeVariance(this);
	...
	for(int i=1;i<=L;i++){
		...
		DTreeVariance currentTree = new DTreeVariance(this);
		...
		if(accuracy > bestAccuracy){
			...
			bestTree = new DTreeVariance(currentTree);
		}
	}
...
class instance{
	...
	instance(String fileLocation) throws IOException{
